...
public class LoginActivity extends AppCompatActivity {
            ...
            JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url + email, null,
                    new Response.Listener<JSONObject>() {
                        ...
                        public void onResponse(JSONObject response) {
                            Log.d("login", "onResponse: logging in");
                            login(email);
                        }
                    }, new Response.ErrorListener() {
                @Override
                public void onErrorResponse(VolleyError error) {
                    Log.d("login", "onErrorResponse: creating new account");
                    // Create new user
                    ...
                    JsonObjectRequest request1 = new JsonObjectRequest(Request.Method.POST, url, objRequest,
                            new Response.Listener<JSONObject>() {
                                @Override
                                public void onResponse(JSONObject response) {
                                    login(email);
    ...
    private void login(String user) {
        ...
        prefs.edit().putString(getString(R.string.pref_user), user).apply();
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                SharedPreferences prefs = getSharedPreferences(getString(R.string.pref_key), MODE_PRIVATE);
                prefs.edit().putString(getString(R.string.pref_user), mEmail).apply();
                Intent intent = new Intent(LoginActivity.this, MainActivity.class);
                startActivity(intent);
            } else {
